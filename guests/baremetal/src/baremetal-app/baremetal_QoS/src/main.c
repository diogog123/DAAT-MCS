...
void main(void){
    ...
    printf("\nCCI QoS Test\n");
    uint32_t disabled_S0 = (p_cci_regs->Qos_control_register_S0 >> QOS_REGULATION_DISABLED_BIT) & 0x1;
    printf("S0_Qos: %u\n", disabled_S0);
    uint32_t disabled_S1 = (p_cci_regs->Qos_control_register_S1 >> QOS_REGULATION_DISABLED_BIT) & 0x1;
    printf("S1_Qos: %u\n", disabled_S1);
    uint32_t disabled_S2 = (p_cci_regs->Qos_control_register_S2 >> QOS_REGULATION_DISABLED_BIT) & 0x1;
    printf("S2_Qos: %u\n", disabled_S2);
    uint32_t disabled_S3 = (p_cci_regs->Qos_control_register_S3 >> QOS_REGULATION_DISABLED_BIT) & 0x1;
    printf("S3_Qos: %u\n", disabled_S3);
    uint32_t disabled_S4 = (p_cci_regs->Qos_control_register_S4 >> QOS_REGULATION_DISABLED_BIT) & 0x1;
    printf("S4_Qos: %u\n", disabled_S4);

    uint32_t rb_before = READ_FIELD(p_cci_regs->read_Qos_override_register_S0,ARQOS_VALUE_MASK,ARQOS_VALUE_SHIFT);
    
    WRITE_FIELD(p_cci_regs->read_Qos_override_register_S0,ARQOS_VALUE_MASK,ARQOS_VALUE_SHIFT,4);

    uint32_t rb_after = READ_FIELD(p_cci_regs->read_Qos_override_register_S0,ARQOS_VALUE_MASK,ARQOS_VALUE_SHIFT);
